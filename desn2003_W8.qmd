...
format: 
  revealjs:
    ...
    incremental: true
---
# Week 8 Reset {background-color="#E9C46A"}

## Good Question, Wrong Method = Bad Research

::: {.callout-important icon=false}
Even strong topics fail when the method is vague, mismatched, or ethically unprepared.
:::

. . .

Today is about getting your project into a state where you can defend:

- what you are doing
- why this method fits
- who or what your evidence source is
- what approval, consent, or data-handling issues must be resolved first

## The Runway From Here

::: {.callout-note icon=false}
## What The Rest of Semester Looks Like
...
- **Apr 21**: last lecture / final presentation launch + **Doc 1 due**
- **Apr 28**: in-class presentation overflow if needed
:::

That means this week is not abstract theory for its own sake. This week is about getting your method locked before the calendar compresses.

## Learning Objectives

By the end of this session, you will be able to:

1. **Identify** research paradigms (positivist, constructivist, pragmatic) in real studies
2. **Select** appropriate qualitative/quantitative methods for your research question
3. **Design** a mixed-methods approach when needed
4. **Articulate** a method justification for Doc 0.2
...
By end of class, complete the **Method Justification Paragraph**:

"My research question is [X]. I will use [method] because [paradigm rationale]. This method is appropriate because [fit to question]. The main limitation is [honest acknowledgment]."

This paragraph goes directly into your Doc 0.2 methodology section.
:::

---

## Week 8 Quick Clinic: Are You Actually Ready?

Before we get abstract again, do a fast self-check.

::: {.columns}
::: {.column width="50%"}
**If your project involves people:**

- Who exactly are your participants?
- How will you recruit them?
- What is one real risk or discomfort?
- How will you record consent?
- What documents are still missing?
:::

::: {.column width="50%"}
**If your project does not involve people directly:**

- What is your actual data source?
- Why is it appropriate to the question?
- What are the limits of that evidence?
- What can you reasonably claim from it?
- What will your analysis actually look like?
:::
:::

## Week 8 Ethics Clinic (10 min)

::: {.callout-note icon=false}
## Use This If You Need Human Participants

Open these now if your project may involve interviews, surveys, observations, or user testing:
...
1. Do I need ethics approval for my current plan?
2. What is my method in one sentence?
3. Who are my participants and how will I recruit them?
4. What is the biggest foreseeable risk?
5. What supporting documents do I still need?

. . .

If you cannot answer these yet, that is the signal. Your methodology is not specific enough yet.
...
# Paradigms & Methods {background-color="#A8DADC"}

## Method Roast (10 min)

::: {.nonincremental}
1. "I want to know why users feel anxious, so I'll run a yes/no survey."
2. "I want to prove my design is better, so I'll interview three friends."
3. "I want to study student behavior, so I'll do 30 interviews, a survey of 500, and an A/B test in two weeks."
:::

. . .

**Roast each plan:** what is broken first?

- wrong method for the question?
- too little evidence?
- unrealistic scope?
- unclear causal claim?
...
## Case Card: Google's "41 Shades of Blue"

::: {.columns}
::: {.column width="55%"}
<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:6px;">
<div style="height:46px;background:#003e8a;"></div>
<div style="height:46px;background:#00408d;"></div>
<div style="height:46px;background:#004290;"></div>
<div style="height:46px;background:#004493;"></div>
<div style="height:46px;background:#004696;"></div>
<div style="height:46px;background:#004899;"></div>
<div style="height:46px;background:#004a9c;"></div>
<div style="height:46px;background:#004c9f;"></div>
<div style="height:46px;background:#004ea2;"></div>
<div style="height:46px;background:#0050a5;"></div>
<div style="height:46px;background:#0052a8;"></div>
<div style="height:46px;background:#0054ab;"></div>
<div style="height:46px;background:#0056ae;"></div>
<div style="height:46px;background:#0058b1;"></div>
<div style="height:46px;background:#005ab4;"></div>
<div style="height:46px;background:#005cb7;"></div>
<div style="height:46px;background:#005eba;"></div>
<div style="height:46px;background:#0060bd;"></div>
<div style="height:46px;background:#0062c0;"></div>
<div style="height:46px;background:#0064c3;"></div>
<div style="height:46px;background:#0066c6;"></div>
<div style="height:46px;background:#0068c9;"></div>
<div style="height:46px;background:#006acc;"></div>
<div style="height:46px;background:#006ccf;"></div>
<div style="height:46px;background:#006ed2;"></div>
<div style="height:46px;background:#0070d5;"></div>
<div style="height:46px;background:#0072d8;"></div>
<div style="height:46px;background:#0074db;"></div>
<div style="height:46px;background:#0076de;"></div>
<div style="height:46px;background:#0078e1;"></div>
<div style="height:46px;background:#007ae4;"></div>
<div style="height:46px;background:#007ce7;"></div>
<div style="height:46px;background:#007eea;"></div>
<div style="height:46px;background:#0080ed;"></div>
<div style="height:46px;background:#0082f0;"></div>
<div style="height:46px;background:#1485f3;"></div>
<div style="height:46px;background:#2488f4;"></div>
<div style="height:46px;background:#348bf5;"></div>
<div style="height:46px;background:#448ef6;"></div>
<div style="height:46px;background:#5491f7;"></div>
<div style="height:46px;background:#6494f8;"></div>
</div>
:::

::: {.column width="45%"}
Google became famous for reportedly testing dozens of link-blue variants to optimize click-through.

**Use this story well:**

- the good version: measure what actually changes behavior
- the bad version: mistake measurable tiny wins for the whole design problem
- the teaching point: **positivism is powerful, but it can become absurd when the metric replaces judgment**

**Discuss:** when is this smart, and when is it pathological?

**Read / show:**

- [WIRED: Google's Data Culture Drives Designer Crazy — and Out](https://www.wired.com/2009/03/googles-data-cu/)
- [Zeldman: 41 Shades of Blue](https://zeldman.com/2009/03/20/41-shades-of-blue/)
:::
:::
...
# AI Research in Practice {background-color="#F4A261"}
...
- **Example – AI Design Assistant (Product):** Imagine testing a Figma plugin powered by GPT that suggests design improvements. You'd measure **usage data** (e.g., how often do designers accept suggestions? which suggestions are ignored?) *and* gather **feedback** (do designers feel it boosts creativity or do they find it annoying?). This mixed approach uncovers both performance metrics and user sentiment.
- **Example – AI in Built Environment:** Consider an AI tool that generates floorplan options for architects. Research questions might include: Do architects trust AI-generated layouts? How do they modify vs. accept suggestions? Does AI assistance change the design process (faster? more homogeneous?)? Methods would combine analytics (which layouts get modified most) with interviews (how do architects feel about AI "co-designing"?).
...
## Watch First: Wizard-of-Oz AI Demo

::: {.columns}
::: {.column width="58%"}
[![](data/wizard_of_oz_nngroup.jpg){fig-alt="Wizard of Oz Method in UX video thumbnail" width="100%"}](https://www.youtube.com/watch?v=gDsb0vW_LM8)
:::

::: {.column width="42%"}
**Why this matters**

- You do **not** need a finished AI system to test the interaction
- You can fake intelligence and still learn about trust, expectations, and workflow
- This is one of the best ways to stop students from saying "I need to build it first"

**Use in class**

1. Watch the NN/g clip: [Wizard of Oz Method in UX](https://www.youtube.com/watch?v=gDsb0vW_LM8)
2. Then ask: what part of your project could be faked by a human behind the curtain?

**Backup reference**

- [MIT: Wizard of Oz = computer frontend, human backend](https://web.mit.edu/6.813/www/sp16/classes/10-prototyping/)
:::
:::
...
- **Constraint:** At least one part of your plan must be runnable **before** the real AI exists.
...
## Academic vs. Product Research Writing

| Dimension | Academic Writing | Product Writing |
|:----------|:-----------------|:----------------|
| **Goal** | Contribute to knowledge | Inform a decision |
| **Audience** | Peer reviewers, scholars | PMs, engineers, executives |
| **Length** | 5,000-10,000 words | 2-3 pages + appendix |
| **Tone** | Formal, hedged ("may suggest") | Direct, confident ("we should") |
| **Structure** | Abstract → Lit Review → Method → Results → Discussion | Opportunity → Findings → Hypothesis → Recommendation |
| **Evidence standard** | Statistical significance, replicability | "Good enough" to de-risk the decision |

Both require rigor. Different outputs.

## Product Writing: The 1-Page Brief

When stakeholders have 5 minutes, give them this:

::: {.callout-note}
## Template: Research Brief (1 Page)

**Opportunity:** [1-2 sentences: What problem are we solving? For whom?]

**What We Learned:**
- [Key finding 1 — supported by X interviews / Y survey responses]
- [Key finding 2 — aligned with [Theory Name] in literature]
- [Key finding 3 — contradicts assumption Z]

**Our Hypothesis:** If we build [feature], then [outcome], because [mechanism].

**Recommendation:** [Build / Test first / Don't build]

**Next Step:** [Specific action with timeline]
:::

## Academic Writing: The Findings Section

When writing for academic readers:

::: {.callout-note}
## Template: Findings Section Structure

**Theme 1: [Name]** (n/N participants)

[Definition of the theme in 1-2 sentences]

[Representative quote with attribution (P##)]

[Analysis: What does this mean? How does it connect to literature?]

**Theme 2: [Name]** (n/N participants)
...
[Inferential statistics: correlation/t-test/etc. with effect size]

[Interpretation: What do these numbers mean in context?]
:::
...
|:-------------|:--------|:----|
| **Quote dumping** | "P3 said X. P7 said Y. P9 said Z." (no analysis) | Add interpretation after each quote |
| **Stats without meaning** | "r = 0.42, p < .001" (so what?) | "This moderate correlation suggests..." |
| **Vague hedging** | "This might possibly suggest..." | Be confident: "This indicates..." |
| **Burying the lead** | Insight on page 5 | Put the most important finding first |
| **Method-heavy, insight-light** | 2 pages on method, 1 paragraph on findings | Flip the ratio |
...
- Would a skeptical reviewer find the claims supported by evidence?
- Is every quote analyzed, not just presented?
- Are limitations acknowledged honestly?

**For product writing:**
- Could a PM make a decision after reading this?
- Is the recommendation clear and justified?
- Are the next steps actionable?
